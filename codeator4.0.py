...
class NativeGraphViewer(tk.Tk):
    def __init__(self):
        ...
        self.console_frame = tk.Frame(self, bg="#1e1e1e", width=300)
    ...
    def load_path(self):
        ...
        self.print_json(self.structure_graph, prefix="=== Structure Graph ===")
